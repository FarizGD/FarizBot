...
`.trim()
    ...
    if (targetUser.level < 20 || user.level < 20) return m.reply(`Minimal level 🔼 kamu atau target adalah 20!`)
    //if (count > 100000) return m.reply(`Maksimal mengirim 100k suatu item ⚠️`)
